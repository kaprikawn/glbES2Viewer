...
@REM cl -Zi /EHsc -wd4312 -DDEBUG=1 ..\src\simple.cpp user32.lib gdi32.lib Shlwapi.lib opengl32.lib /I%SDL_ROOT_DIR%\include /I%GLEW_ROOT_DIR%/include /link /LIBPATH:%SDL_ROOT_DIR%\lib\x64 /LIBPATH:%GLEW_ROOT_DIR%\lib\Release\x64 SDL2.lib SDL2main.lib glew32.lib /OUT:glbES2Viewer.exe
